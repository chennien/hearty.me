...
function signout(f){if(f==null){alertify.set({labels:{ok:"否",cancel:"登出 🔑"},buttonReverse:!1});alertify.confirm("確定要登出嗎？",function(e){if(!e){ga_event_push("Sign Out",{event_category:"Auth",event_label:"Sign Out"});window.sessionStorage.clear();window.location.assign("//hearty.me/signout")}})}
else{window.sessionStorage.clear();window.location.assign("//hearty.me/signout")}}
