"use strict";if(window.top.location.href!==window.self.location.href&&(!/(hearty)/.test(location.pathname)))
...
function hj_screenshot(){autosave_the_change();hj_loading(!0);hj_getScript("//cdn.jsdelivr.net/npm/html2canvas@1.0.0-alpha.12/dist/html2canvas.min.js",function(){var post_id=current_post()["post_id"],$pg=$(".bk-list .bk-page"),$e=$pg.find(".diary"),$d=$(".diary_screenshot");$e.addClass("screenshoted");$pg.scrollTop(0);$pg.find("#editor_editable").removeClass("editor_margin_bottom");$pg.find(".picture .far").hide();window.html2canvas($e.get(0),{useCORS:!0,scale:window.devicePixelRatio,width:$e.get(0).offsetWidth+10,height:$e.get(0).offsetHeight}).then((c)=>{var b64=c.toDataURL("image/png"),subject=$pg.find("#subject").text();$d.empty();$("<a>",{target:"_blank",href:b64,download:"溫度日記_"+subject+".png",title:"下載："+subject}).html($("<img>",{src:b64})).appendTo($d).get(0).click();$e.removeClass("screenshoted");$pg.find("#editor_editable").addClass("editor_margin_bottom");$pg.find(".picture .far").show();popup_toggle(!0,"diary_screenshot");hj_loading(!1);hj_mixpanel("Post Screenshoted",{post_id:post_id});ga_event_push("Screenshot",{event_category:"Posts",event_label:"Screenshot"})})})}
