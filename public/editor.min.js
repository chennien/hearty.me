...
window.history.replaceState({},post.title+" ♥ 溫度日記 Hearty Journal","/"+hj_writer+"/"+post_id);editor_enable();setcookie("hearty_last_viewed",post_id,1);hj_mixpanel("Post Loaded",{post_id:post_id});ga_event_push("Post Loaded",{event_category:"Posts",event_label:"Post Loaded"});break;case 3:signin_required();break;case 4:signin_required();break}
return r.Status===1}
